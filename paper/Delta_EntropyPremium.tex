...
Table~\ref{tab:ashare} reports A-share FM regressions. Residual H\_smooth is directionally consistent (t = $-1.67$), and the H$\times$D interaction is marginally significant (t = $+1.70$). The entropy premium strengthens at the 2-quarter horizon (t = $-1.90$), consistent with the US result.
